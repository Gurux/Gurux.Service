...
namespace Gurux.Service_Simple_Unit_Test
{
    ...
    public class MariaDbSqlTest : BaseTest
    {
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT Guid FROM TestClass ORDER BY Guid LIMIT 1,2")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("UPDATE TestClass SET Guid = {0}, Time = '{1}' WHERE ID = 2")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("UPDATE GuidTestClass SET Time = '{0}' WHERE Id = {1}")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT Guid FROM TestClass WHERE Time >= '2014-01-02 00:00:00.000'")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT Guid FROM TestClass WHERE Time IS NULL OR Time = '0001-01-01 00:00:00.000'")]
