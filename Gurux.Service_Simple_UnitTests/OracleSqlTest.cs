...
namespace Gurux.Service_Simple_Unit_Test
{
    ...
    public class OracleSqlTest : BaseTest
    {
        ...
        [DataRow(new string[]
           {
            ...
            }, "DELETE FROM GUIDTESTCLASS WHERE ID IN(HEXTORAW('{0}'), HEXTORAW('{1}'))")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT TIME FROM TESTCLASS WHERE TIME > TO_TIMESTAMP('0001-01-01 00:00:00.000', 'YYYY-MM-DD HH24:MI:SS.FF3') AND TIME < TO_TIMESTAMP('9999-12-31 23:59:59', 'YYYY-MM-DD HH24:MI:SS')")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("INSERT INTO NULLABLETESTCLASS (ID, ACTIVE, TEXT) VALUES(HEXTORAW('{0}'), 0, 'Gurux')")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("INSERT INTO NULLABLETESTCLASS (ID, ACTIVE, TEXT) VALUES(HEXTORAW('{0}'), 1, 'Gurux')")]
