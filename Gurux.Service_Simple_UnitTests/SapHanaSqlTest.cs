...
namespace Gurux.Service_Simple_Unit_Test
{
    ...
    public class SapHanaSqlTest : BaseTest
    {
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT TIME FROM TESTCLASS WHERE TIME > TO_TIMESTAMP('0001-01-01 00:00:00') AND TIME < TO_TIMESTAMP('9999-12-31 23:59:59.999')")]
        ...
        {
            expected = string.Format(expected, string.Join(", ", guids.Select(it => $"X'{Convert.ToHexString(Guid.Parse(it).ToByteArray())}'")));
        ...
        /// </summary>
        [TestMethod]
        [DataRow("INSERT INTO PARAMETER2 (NAME, VALUE, DEVICEID) SELECT 'Name1', 'Value1', 0 FROM DUMMY UNION ALL SELECT 'Name2', 'Value2', 0 FROM DUMMY UNION ALL SELECT 'Name3', 'Value3', 0 FROM DUMMY", "INSERT INTO PARAMETER2 (NAME, VALUE) SELECT 'Name1', 'Value1' FROM DUMMY UNION ALL SELECT 'Name2', 'Value2' FROM DUMMY UNION ALL SELECT 'Name3', 'Value3' FROM DUMMY")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("INSERT INTO NULLABLETESTCLASS (ID, ACTIVE, TEXT) VALUES({0}, FALSE, 'Gurux')")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("INSERT INTO NULLABLETESTCLASS (ID, ACTIVE, TEXT) VALUES({0}, TRUE, 'Gurux')")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("UPDATE TESTCLASS SET GUID = {0}, TIME = TO_TIMESTAMP('{1}') WHERE ID = 2")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("UPDATE GUIDTESTCLASS SET TIME = TO_TIMESTAMP('{0}') WHERE ID = {1}")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("UPDATE TESTCLASS SET GUID = X'00000000000000000000000000000000', TIME = TO_TIMESTAMP('2014-01-02 00:00:00.000') WHERE TEXT = 'Gurux'")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("UPDATE NULLABLETESTCLASS SET ACTIVE = TRUE, TEXT = NULL WHERE ID = {0}", "UPDATE NULLABLETESTCLASS SET ACTIVE = TRUE, TEXT = NULL WHERE ID = {0}", "UPDATE NULLABLETESTCLASS SET ACTIVE = FALSE, TEXT = NULL WHERE ID = {0}")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT GUID FROM TESTCLASS WHERE TIME >= TO_TIMESTAMP('{0}')")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT GUID FROM TESTCLASS WHERE TIME IS NULL OR TIME = TO_TIMESTAMP('{0}')")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT GUID FROM TESTCLASS WHERE TIME IN (TO_TIMESTAMP('{0}'))")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT CASE WHEN NOT EXISTS (SELECT 1 FROM TESTCLASS) THEN 1 ELSE 0 END AS IsEmpty FROM DUMMY")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT CASE WHEN NOT EXISTS (SELECT 1 FROM TESTCLASS WHERE ID = 1) THEN 1 ELSE 0 END AS IsEmpty FROM DUMMY")]
