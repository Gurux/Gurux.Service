...
namespace Gurux.Service_Simple_Unit_Test
{
    ...
    public class MSSqlTest : BaseTest
    {
        ...
        /// </summary>
        [TestMethod]
        [DataRow("SELECT Time FROM TestClass WHERE Time > '17530101' AND Time < '9999-12-31T23:59:59.999'")]
        ...
        /// </summary>
        [TestMethod]
        [DataRow("UPDATE TestClass SET Guid = '00000000-0000-0000-0000-000000000000', Time = '2014-01-02T00:00:00.000' WHERE Text = 'Gurux'")]
