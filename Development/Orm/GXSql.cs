...
namespace Gurux.Service.Orm
{
    ...
    public static class GXSql
    {
        ...
        /// arg.Columns.Add&lt;TestClass&gt;(q =&gt; GXSql.Count(null));
        /// arg.Columns.Add&lt;TestClass&gt;(q =&gt; GXSql.Count("*"));
        /// arg.Columns.Add&lt;TestClass&gt;(q =&gt; GXSql.Count("column name"));
        ...
        /// <summary>
        /// Return distinct count of selected objects.
        /// </summary>
        /// <param name="expression">Expression to count.</param>
        /// <returns>Count of distinct selected objects.</returns>
        ...
        /// <summary>
        /// Is value in the selected values.
        /// </summary>
        /// <param name="value">Value to search.</param>
        /// <param name="expression">Selection arguments.</param>
        /// <returns>True, if value exists.</returns>
        ...
        /// <param name="expression">Expression to compare.</param>
        /// <returns>True, if value exists.</returns>
        ...
        /// <summary>
        /// Is value greater than expression.
        /// </summary>
        /// <typeparam name="T">Value type.</typeparam>
        /// <param name="value">Value to compare.</param>
        /// <param name="expression">Expression to compare.</param>
        ...
        /// <summary>
        /// Is value greater than or equal to expression.
        /// </summary>
        /// <typeparam name="T">Value type.</typeparam>
        /// <param name="value">Value to compare.</param>
        /// <param name="expression">Expression to compare.</param>
        ...
        /// <summary>
        /// Is value less than or equal to expression.
        /// </summary>
        /// <typeparam name="T">Value type.</typeparam>
        /// <param name="value">Value to compare.</param>
        /// <param name="expression">Expression to compare.</param>
